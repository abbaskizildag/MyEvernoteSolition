...
namespace MyEvernote.Entities.ValueObject
{
    public class RegisterViewModel
    {
        ...
        [DisplayName("E-posta"), Required(ErrorMessage = "{0} alanı boş geçilemez"), StringLength(70, ErrorMessage = "{0} max. {1} karakter olmalı"), EmailAddress(ErrorMessage ="{0} alanı için geçerli bir e-post adresi giriniiz.")]
